						...
						<div class="row row-md">
							<div class="col col-6 col-md-6">
								<h2 class="bar-title">
									...
									<span>Edit Form Meta</span>
								</h2>
							</div>
							<div class="col col-6 col-md-6">
								<div class="bar-buttons">
									<a href="<?php $site->urlTo("/backend/formsmeta/new", true); ?>" class="button button-secondary" title="New Form Meta"><i class="fa fa-fw fa-plus"></i><span class="hide-mobile-inline"> New Manager</span></a>
								</div>
							</div>
						</div>
					</div>
