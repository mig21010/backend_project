<?php
	...
	class User extends CROOD {
		...
		function init($args = false) {
			...
			$this->table = 					'user';
			$this->table_fields = 			array('id', 'login', 'slug', 'email', 'nicename', 'password', 'status', 'type', 'created', 'modified');
			$this->update_fields = 			array('login', 'slug', 'email', 'nicename', 'password', 'status', 'type', 'modified');
	...
	class Users extends NORM {
		...
		protected static $table_fields = 			array('id', 'login', 'slug', 'email', 'nicename', 'password', 'status', 'type', 'created', 'modified');
