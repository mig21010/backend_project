						...
						<div class="metabox">
							...
							<div class="metabox-body">
								<div class="the-content">
									<h3 class="has-tagline">Are you sure you want to delete <strong><?php sanitized_print($item->nicename) ?></strong>?</h3>
									<p class="tagline">Warning: This action can not be undone, all the item data will be lost if you continue.</p>
									<form action="" method="post">
										<div class="form-actions">
											<a href="<?php $site->urlTo('/backend/managers', true); ?>" class="button button-link">&laquo; No, go back to list</a>
