					...
					<div class="margins-horz">
						<div class="panel-wrapper fixed-left">
							...
							<div class="panel-fluid">
								<?php if ($search): ?>
									<div class="message message-info">Showing filtered results for <strong><?php sanitized_print($search) ?></strong>. <a href="<?php $site->urlTo('/backend/forms', true); ?>">Click here</a> to reset the filters.</div>
								<?php endif; ?>
								<div class="metabox">
